# Feature 03 — Couche d’ingestion et extracteurs CSV
    ...
    ## Objectif
    Lire proprement les fichiers CSV métiers en renvoyant des résultats d’extraction structurés sans introduire de logique métier.
...
- extracteurs spécialisés appels entrants, appels sortants, tickets
- gestion des erreurs de lecture et journalisation
- fixtures d’intégration dérivées des fichiers sources
...
## Livrables attendus
- extracteurs CSV testés
- configuration explicite de lecture
- tests d’intégration sur fichiers de test réalistes
- documentation d’usage minimal

## Critères d’acceptation
- les fichiers de test se chargent sans crash non géré
- les erreurs de parsing sont encapsulées dans `ExtractionError`
- `ExtractionResult` contient source, colonnes, nombre de lignes et messages

## Dépendances
`01_project_bootstrap`, `02_domain_models_and_exceptions`
