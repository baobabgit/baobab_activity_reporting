"""Tests pour TelephonyOverviewNarrativeWriter."""
...
class TestTelephonyOverviewNarrativeWriter:
    """Tests unitaires pour TelephonyOverviewNarrativeWriter."""

    def test_delegates_when_included(self) -> None:
        """Délègue au rédacteur téléphonie."""
        ...
        kpis = [{"code": "telephony.incoming.count", "value": 3.0}]
        ...
        assert len(TelephonyOverviewNarrativeWriter().write(ctx)) >= 1
