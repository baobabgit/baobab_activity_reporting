"""Tests pour AttentionPointsNarrativeWriter."""
...
class TestAttentionPointsNarrativeWriter:
    """Tests unitaires pour AttentionPointsNarrativeWriter."""

    def test_framing_paragraph(self) -> None:
        """Un paragraphe de cadrage pour la vigilance."""
        ...
        paras = AttentionPointsNarrativeWriter().write(ctx)
        assert len(paras) == 1
        assert "écarts" in paras[0].lower()
