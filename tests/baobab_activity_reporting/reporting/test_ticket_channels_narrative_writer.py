"""Tests pour TicketChannelsNarrativeWriter."""
...
class TestTicketChannelsNarrativeWriter:
    """Tests unitaires pour TicketChannelsNarrativeWriter."""

    def test_included(self) -> None:
        """Délègue au rédacteur traitement ticket."""
        ...
        kpis = [{"code": "tickets.channel.C.count", "label": "C", "value": 5.0}]
        ...
        assert TicketChannelsNarrativeWriter().write(ctx)
