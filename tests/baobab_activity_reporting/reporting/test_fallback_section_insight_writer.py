"""Tests pour FallbackSectionInsightWriter."""
...
class TestFallbackSectionInsightWriter:
    """Tests unitaires pour FallbackSectionInsightWriter."""

    def test_always_empty(self) -> None:
        """Pas d'insights mécaniques par défaut."""
        ed = EditorialSectionDefinition(
            section_code="unknown_insight",
            section_title="U",
            section_objective="",
        ...
        full = ReportContext(p, [{"code": "a", "value": 1.0}])
        ...
        assert FallbackSectionInsightWriter().write(ctx) == []
