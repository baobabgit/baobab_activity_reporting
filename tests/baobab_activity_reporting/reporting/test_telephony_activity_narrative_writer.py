"""Tests pour TelephonyActivityNarrativeWriter."""
...
class TestTelephonyActivityNarrativeWriter:
    """Tests unitaires pour TelephonyActivityNarrativeWriter."""

    def test_included_with_volumes(self) -> None:
        """Paragraphe sur volumes sans code KPI."""
        ...
        kpis = [
            {"code": "telephony.incoming.count", "value": 4.0},
        ...
        out = TelephonyActivityNarrativeWriter().write(ctx)
        assert len(out) >= 1
