"""Tests pour SiteBreakdownNarrativeWriter."""
...
class TestSiteBreakdownNarrativeWriter:
    """Tests unitaires pour SiteBreakdownNarrativeWriter."""

    def test_included(self) -> None:
        """Délègue au rédacteur charge site."""
        ed = EditorialSectionDefinition(
            section_code="site_breakdown",
            section_title="Sites",
            section_objective="",
        ...
        kpis = [{"code": "site.Paris.k", "value": 2.0}]
        ...
        assert SiteBreakdownNarrativeWriter().write(ctx)
